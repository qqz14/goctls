...
import (
	"github.com/qqz14/goctls/api/swagger"
	"github.com/spf13/cobra"

	"github.com/qqz14/goctls/api/apigen"
	"github.com/qqz14/goctls/api/docgen"
	"github.com/qqz14/goctls/api/format"
	"github.com/qqz14/goctls/api/gogen"
	"github.com/qqz14/goctls/api/new"
	"github.com/qqz14/goctls/api/validate"
	"github.com/qqz14/goctls/config"
	"github.com/qqz14/goctls/internal/cobrax"
	"github.com/qqz14/goctls/plugin"
)
...
func init() {
	...
	goCmdFlags.StringVarP(&gogen.VarStringResponsePackage, "response", "R")
