...
func init() {
	...
	dockerCmdFlags.StringVarPWithDefaultValue(&varStringBase, "base", "a", "alpine:3.22")
	...
	dockerCmdFlags.StringVarPWithDefaultValue(&varStringImage, "image", "i", "golang:1.24.5-alpine3.21")
